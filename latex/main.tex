...
As medidas de tendência central e dispersão foram calculadas para as três variáveis de interesse: IDEB, proporção de renda até 1/2 salário mínimo, e salário médio formal. A moda foi dispensada devido à natureza contínua das variáveis numéricas. Os valores referem-se às amostras de $n=30$ municípios em cada estado.
...
Os valores descritivos de referência estão resumidos nas Tabelas \ref{tab:descritiva_pb} e \ref{tab:descritiva_rn}. As tabelas completas (incluindo populações e todas as estatísticas) foram disponibilizadas no link de reprodutibilidade da Subseção 1.3.
...
% Tabelas de estatísticas descritivas por estado
\input{tables/tab_descritiva_pb.tex}
\input{tables/tab_descritiva_rn.tex}
